...
#include "thirdparty/or-tools/ortools/base/logging.h"
#include "thirdparty/or-tools/ortools/linear_solver/linear_solver.h"
#include "thirdparty/or-tools/ortools/linear_solver/linear_solver.pb.h"
#include "core/reference.h"
#include "thirdparty/or-tools/ortools/linear_solver/linear_solver.h"

class OrTools : public Reference {
	GDCLASS(OrTools, Reference);
...
public:
	int solve() {
		...
		operations_research::MPSolver solver("LinearProgrammingExample",
		...
		// Object if function: Maximize 3x + 4y.
